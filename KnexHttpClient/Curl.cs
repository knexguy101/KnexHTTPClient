...
namespace KnexHttpClient
{
    class Curl
    {
        ...
        //This converts a given curl command to a format that the curl request can use
        //It runs it in a console, returning the value when it is done.
        public static string ExecuteCurl(string curlCommand, int timeoutInSeconds = 60)
        {
            try
            {
                ...
                // this code only works on windows 10 or higher
                {
                    ...
                    {
                        if (Debugger.IsAttached) { Debugger.Break(); /* if you debug in vs this will keep that shit from breaking*/ }
